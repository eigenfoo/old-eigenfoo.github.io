...
In plain English, if you have high-dimentional data (i.e. a large number of
...
$$J_1$$! I don't want to go into the algebra here, but if you really want to see
it, Fukunaga is a great resource. The end result, however, is LDA as presented.
