...
excerpt: "Linear discriminant analysis? Quadratic? What?"
header:
...
common dimensionality reduction and technique for classification problems.
However, that's something of an understatement: it does so much more than "just"
...
analysis_, but more on that later).
